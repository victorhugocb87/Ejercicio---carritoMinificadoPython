...
class Persona:
    ...
    def saludar(self):
        respuesta =""
        if (self.estado == 1):
           respuesta = "Soy %s %s vivo en %s" % (self.nombre, self.apellido, self.direccion)
        return respuesta
    ...
    def estadoSistema(self):
        if (self.estado == 1):
            ...
            return "Soy %s , No Estoy Habiitado/a en el sistema" % (self.nombre)
    def darBaja(self):
        self.estado = 0
    ...
    def darAlta(self):
        if (self.estado == 1):
            return "Alerta.!! , %s ya esta de Alta" % (self.nombre)
        else:    
            self.estado = 1
...
pedro = Persona("Pedro", "Perez", "76352102",
                 "Zona Primer Anillo", "01/01/1980")    
pablo = Persona("Pablo", "Mercado", "76358402",
                 "Zona 2do Anillo", "12/12/1984")
vilma = Persona("Vilma", "Torrez", "70958402",
                 "Zona Primer Anillo", "28/04/1985")  
betty = Persona("Betty", "Cardozo", "70954502",
                 "Zona 2do Anillo", "18/06/1987") 
