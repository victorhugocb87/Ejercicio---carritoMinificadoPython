...
permisos.guardar(1, 'JOSE MERCADO', 'COROLLA', 'TOYOTA', '2504TDA', 'SANTA CRUZ', '15/06/2020',
                 'PERMISO PARA IR AL TRABAJO', 0)
permisos.guardar(2, 'ALBERTO MERCADO', 'HILUX', 'TOYOTA', '2640SDA', 'TARIJA', '12/04/2020',
                 'PERMISO PARA IR AL TRABAJO', 0)
permisos.guardar(3, 'GABRIEL MELGAR', 'SENTRA', 'NISSAN', '3204NTS', 'BENI', '30/05/2020', 'PERMISO PARA IR AL TRABAJO',
                 0)
...
permisos.guardar(6, 'CARLOS MONTERO', 'CIVIC', 'HONDA', '2804STA', 'SANTA CRUZ', '10/06/2020',
                 'PERMISO PARA IR AL TRABAJO', 0)
permisos.guardar(7, 'PABLO ALEMAN', 'YARIS', 'TOYOTA', '2054PDA', 'LA PAZ', '22/06/2020', 'PERMISO PARA IR AL TRABAJO',
                 0)
